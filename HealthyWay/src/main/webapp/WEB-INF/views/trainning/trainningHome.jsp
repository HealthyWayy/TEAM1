		    ...
		    <div class="myDiv">
		        ...
		        <form action="/trainning/add_mytrain_list" method="post" id="mytrainFrm">
		        	<div class="my-list-Div">
			            ...
			            <ul class="my_train" id="my_train2">
			        		
			        	</ul>			        	
		        	</div>
		        	<div>
		        		<input class="my-input1" type="text" name="train_title" placeholder="저장할 운동 루틴 이름을 입력하세요." style="margin:0;padding:0">
